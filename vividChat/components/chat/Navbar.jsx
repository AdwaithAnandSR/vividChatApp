...
const Navbar = ({ chatPartnerUsername }) => (
	<View className="flex-row items-center w-full h-[9vh] ">
		<TouchableOpacity onPress={()=> router.back()} className="w-10 h-10 flex justify-center items-center rounded-full">
